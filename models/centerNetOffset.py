...
resnetSizeTerminal = ResNetTerminal("regr", 4, 128, regressionInitializerRes, makeResnetTerminal, process)
resnetOffsetTerminal = ResNetTerminal("offset", 2, 128, regressionInitializerRes, makeResnetTerminal, process)
