...
from models.centerNetOffseth import CenterNetResidual, CenterNetLoss, centerNetEvaluation, CenterNetHourglass
...
modelParams = {'numLayers': 10,
               'dims': [32, 32, 64, 128, 256, 128, 128, 128] }
# modelParams = {}
